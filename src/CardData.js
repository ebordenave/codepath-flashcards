...
const CardData = [
  { back: "Data Structure", front: "A ______ is a data" +
  ...
  { back: "Stack", front: "A _____ is an abstract data type that" +
      " can be implemented using arrays or linked lists. A _____ follows the" +
      " LIFO principle (Last In, First Out).", difficulty: "medium", image: "placeholder", title:"Stack"},
  { back: "Queue", front: "A _____ is an abstract data type that" +
      " can be implemented using arrays or linked lists. A _____ follows the" +
      " FIFO principle (First In, First Out).", difficulty: "medium", image: "placeholder", title: "Queue"},
  { back: "Algorithm", front: "An __________ is a finite sequence" +
  ...
  { back: "Record", front: "Also called a tuple or struct, a" +
      " ______ is an aggregate data structure. A ______ is a value that" +
  ...
  { back: "Linked List", front: "A ___________ is a linear" +
